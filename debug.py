...
import numpy as np
import sys
from utils import read_correspondence_from_dump
sys.path.append("correspondence-discrete-optim")
...
img1 = cv2.imread("data_light/images/opencv_frame_0.png")
img2 = cv2.imread("data_light/images/opencv_frame_1.png")

im_mask1 = cv2.imread("data_light/images_mask/opencv_frame_0.png")
im_mask2 = cv2.imread("data_light/images_mask/opencv_frame_1.png")
...
CORRESPONDENCES_PRECOMPUTED = read_correspondence_from_dump("data_heavy/corr-exact.txt")
RES_DICT = {}
for pair in CORRESPONDENCES_PRECOMPUTED:
    x, y, x2, y2 = map(int, pair[:4])
    RES_DICT[(x, y)] = (x2, y2)

F_MAT = np.load("data_light/f_mat.npy")
mouseX = -1
mouseY = -1
mouseX2 = -1
mouseY2 = -1
